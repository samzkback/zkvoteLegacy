...
export const JoinGroupButton = (props: ComponentProps<typeof Button>) => {
  return <Button {...props}>Join</Button>;
};

export const CreateGroupButton = (props: ComponentProps<typeof Button>) => {
  return <Button {...props}>Create</Button>;
};

export const VoteButton = (props: ComponentProps<typeof Button>) => {
